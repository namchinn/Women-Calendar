    ...
    return (
        <View>
            ...
            <Modal
                visible={modal3}
                transparent
                onRequestClose={() => odorNemeh}
                animationType='slide'
            >
                <View style={styles.centered_view}>
                    <View style={styles.modal}>
                        <View style={styles.dayTitle}>
                            <Text style={styles.textModalTitle}>САНУУЛГА!</Text>
                        </View>
                        <View style={{ height: 200, justifyContent: 'center', alignItems: 'center' }}>

                            <Text style={styles.textModal}>Та тохиргоо хийсэн тул аппликейшнийг гаргаад оруулаарай.</Text>
                        </View>
                        <TouchableOpacity style={{ backgroundColor: '#8D00CC', height: 51, justifyContent: 'center', alignItems: 'center', borderBottomRightRadius: 20, borderBottomLeftRadius: 20 }} onPress={() => modal3Onpress()}>
                            <Text style={styles.textModalButton}>За</Text>
                        </TouchableOpacity>
                    </View>
                </View>
